...
CSprite::CSprite(LPDIRECT3DDEVICE9 d3ddv)
{
	_Texture = nullptr;
...
bool CSprite::Load(LPWSTR FilePath, D3DCOLOR Transcolor)
{
...
void CSprite::Render(float X, float Y, int Left, int Top, int Width, int Height, float ScaleSize)
{
	D3DXMATRIX Combined;
...
void CSprite::Render(float X, float Y, float ScaleSize)
{
	D3DXMATRIX Combined;
